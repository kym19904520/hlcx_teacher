...
public class ChooseTypeDialog extends Dialog {
    ...
    public ChooseTypeDialog(Context context, List<NameValue> objects) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CommonAdapter<NameValue>(context, list, R.layout.item_lv_type) {
            @Override
    ...
    public ChooseTypeDialog setChooseListener(ChooseListener listener) {
