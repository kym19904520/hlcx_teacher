...
// 记录按下时的Y值
            ...
            case MotionEvent.ACTION_MOVE:
                /*if (canPullUp && deltaY<-200 &&  mListViewListener!=null){
                    mListViewListener.showBottomView();
                }*/
...
//deltaY>0是下拉;deltaY<0是上拉
        ...
        if (deltaY<-200 && mListViewListener!=null){//稍微拉一点再加载
            mListViewListener.onPullToLoadMore();
        }
    }
