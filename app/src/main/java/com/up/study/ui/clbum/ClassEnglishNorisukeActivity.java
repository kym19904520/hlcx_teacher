...
public class ClassEnglishNorisukeActivity extends BaseFragmentActivity {
...
//        map = adapter.getMap();
    ...
    protected void initData() {
        tvTitle.setText(R.string.class_english_jf);
    }
    ...
    public void onViewClicked() {
        EventBus.getDefault().post(new MapEventBus(map));
        finish();
    }
}
