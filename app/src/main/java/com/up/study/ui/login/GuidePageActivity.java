...
public class GuidePageActivity extends BaseFragmentActivity implements ViewPager.OnPageChangeListener{
    ...
    public void initPoint(){
        ...
        for (int i = 0; i < size; i++) {
            ...
            LinearLayout.LayoutParams params=new LinearLayout.LayoutParams(StringUtils.dip2Px(GuidePageActivity.this,15), StringUtils.dip2Px(GuidePageActivity.this,15));
