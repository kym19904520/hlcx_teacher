...
public class CommonDialog {
    ...
    public static class Builder {
        ...
        public Builder setPositiveButton(int text, final View.OnClickListener listener, int color) {
            mViewHolder.tvPositiveButton.setVisibility(View.VISIBLE);
            hasPos = true;
            mViewHolder.tvPositiveButton.setText(text);
        ...
        public Builder setNegativeButton(int text, final View.OnClickListener listener, int color) {
            mViewHolder.tvNegativeButton.setVisibility(View.VISIBLE);
            hasNeg = true;
            mViewHolder.tvNegativeButton.setText(text);
        ...
        private void initView() {
            ...
            mView = LayoutInflater.from(mContext).inflate(R.layout.layout_common_dialog, null);
