...
public class StudentAnalyzeDetailsAdapter extends MyBaseAdapter<MyStudentDataBean.KnowBean> {

    public StudentAnalyzeDetailsAdapter(Context context, List<MyStudentDataBean.KnowBean> mDataSets) {
